...
const deleteDbQuestion = async (details) => {
  ...
  const params = {
    TableName: questionTable,
    Key: { quizName: quizName, questionID: questionID },
  };
...
const updateQuestionDb = async (details) => {
  ...
  const params = {
    ...
    UpdateExpression:
      "SET question_type = :question_type, question_body = :question_body, answer1_body = :answer1_body, answer2_body = :answer2_body, answer3_body = :answer3_body, answer4_body = :answer4_body, answer5_body = :answer5_body, correctAnswer = :correctAnswer",
    ExpressionAttributeValues: {
      ":question_type": question_type,
      ":question_body": question_body,
      ":correctAnswer": correctAnswer,
